...
nnoremap <Leader>[ /<C-R>=<SID>ScopeSearch('[m', 1)<CR><CR>
vnoremap <Leader>[ <Esc>/<C-R>=<SID>ScopeSearch('[m', 2)<CR><CR>gV
...
nnoremap <Leader>/ /<C-R>=<SID>ScopeSearch('[m', 0)<CR>
vnoremap <Leader>/ <Esc>/<C-R>=<SID>ScopeSearch('[m', 2)<CR><CR>
